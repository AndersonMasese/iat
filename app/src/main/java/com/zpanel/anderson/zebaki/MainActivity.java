...
*/
            Intent intent=new Intent(MainActivity.this,Professionals.class);
    ...
    private void setupViewPager(ViewPager viewPager) {
        ...
        adapter.addFragment(new tab4(), "kwetu");
        adapter.addFragment(new tab2(), "referrals");
        adapter.addFragment(new tab3(), "account");
